...
{
    using TAccessModel = QTPriceChecker.Logic.Models.Account.Identity;
    using TOutModel = QTPriceChecker.WebApi.Models.Account.AccessIdentity;
    using TEditModel = QTPriceChecker.WebApi.Models.Account.AccessIdentityEdit;
    ///
    ...
    public sealed partial class IdentitiesController : Controllers.GenericController<TAccessModel, TEditModel, TOutModel>
    {
        ...
        /// Generated by the generator
        ///
        public IdentitiesController(QTPriceChecker.Logic.Contracts.Account.IIdentitiesAccess<TAccessModel> other)
        : base(other)
        {
            Constructing();
            Constructed();
