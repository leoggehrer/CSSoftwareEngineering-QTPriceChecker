...
namespace QTPriceChecker.WebApi.Controllers.Account
{
    ...
    using TEditModel = QTPriceChecker.WebApi.Models.Account.IdentityUserEdit;
    using TOutModel = QTPriceChecker.WebApi.Models.Account.IdentityUser;
    ///
    ...
    public sealed partial class IdentityUsersController : Controllers.GenericController<TAccessModel, TEditModel, TOutModel>
    {
        ...
        /// Generated by the generator
        ///
        public IdentityUsersController(QTPriceChecker.Logic.Contracts.Account.IUsersAccess<TAccessModel> other)
        : base(other)
        {
            Constructing();
            Constructed();
