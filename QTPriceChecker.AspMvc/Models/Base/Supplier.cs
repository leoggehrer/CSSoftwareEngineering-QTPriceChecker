...
namespace QTPriceChecker.AspMvc.Models.Base
{
    ...
    public partial class Supplier
    {
        ...
        /// Generated by the generator
        ///
        public System.Collections.Generic.List<QTPriceChecker.AspMvc.Models.Base.ProductXSupplier> SupplierXProducts
        {
            get;
            set;
        }
        ...
        public void CopyProperties(QTPriceChecker.Logic.Entities.Base.Supplier other)
        {
            ...
            if (handled == false)
            {
                Name = other.Name;
                State = other.State;
                SupplierXProducts = other.SupplierXProducts.Select(e => QTPriceChecker.AspMvc.Models.Base.ProductXSupplier.Create((object)e)).ToList();
