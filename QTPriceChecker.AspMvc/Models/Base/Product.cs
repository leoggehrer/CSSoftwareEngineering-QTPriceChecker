...
namespace QTPriceChecker.AspMvc.Models.Base
{
    ...
    public partial class Product
    {
        ...
        /// Generated by the generator
        ///
        public System.Collections.Generic.List<QTPriceChecker.AspMvc.Models.Base.SupplierXProduct> SupplierXProducts
        {
            get;
            set;
        }
        ...
        public void CopyProperties(QTPriceChecker.Logic.Entities.Base.Product other)
        {
            ...
            if (handled == false)
            {
                ...
                Unit = other.Unit;
                State = other.State;
                SupplierXProducts = other.SupplierXProducts.Select(e => QTPriceChecker.AspMvc.Models.Base.SupplierXProduct.Create((object)e)).ToList();
