...
namespace QTPriceChecker.AspMvc.Models.Base
{
    ...
    public partial class ProductFilter : Models.View.IFilterModel
    {
        ...
        /// Generated by the generator
        ///
        public bool HasEntityValue => Number != null || Designation != null || Description != null || State != null;
        ...
        {
            return $"Number: {(Number ?? "---")} Designation: {(Designation ?? "---")} Description: {(Description ?? "---")} State: {(State != null ? State : "---")} ";
        }
    }
}
