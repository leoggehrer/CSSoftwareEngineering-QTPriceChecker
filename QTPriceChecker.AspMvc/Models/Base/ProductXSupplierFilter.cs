...
namespace QTPriceChecker.AspMvc.Models.Base
{
    ...
    public partial class ProductXSupplierFilter : Models.View.IFilterModel
    {
        ...
        /// Generated by the generator
        ///
        public bool HasEntityValue => SupplierId != null || ProductId != null || MinPrice != null || MaxPrice != null;
        ...
        {
            return $"SupplierId: {(SupplierId != null ? SupplierId : "---")} ProductId: {(ProductId != null ? ProductId : "---")} MinPrice: {(MinPrice != null ? MinPrice : "---")} MaxPrice: {(MaxPrice != null ? MaxPrice : "---")} ";
        }
    }
}
