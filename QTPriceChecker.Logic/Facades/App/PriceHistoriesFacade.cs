//@GeneratedCode
namespace QTPriceChecker.Logic.Facades.App
{
    using TModel = Models.App.PriceHistory;
    using TEntity = Entities.App.PriceHistory;
    using System;
    public sealed partial class PriceHistoriesFacade : FacadeObject, Contracts.App.IPriceHistoriesAccess<TModel>
    {
        private Contracts.App.IPriceHistoriesAccess<TEntity> Controller => (ControllerObject as Contracts.App.IPriceHistoriesAccess<TEntity>)!;
#if ACCOUNT_ON
        ...
        public PriceHistoriesFacade()
        : base(new QTPriceChecker.Logic.Controllers.App.PriceHistoriesController())
        {
            Constructing();
            Constructed();
        }
        public PriceHistoriesFacade(FacadeObject facadeObject)
        : base(new QTPriceChecker.Logic.Controllers.App.PriceHistoriesController(facadeObject.ControllerObject))
        {
            Constructing();
            Constructed();
        }
