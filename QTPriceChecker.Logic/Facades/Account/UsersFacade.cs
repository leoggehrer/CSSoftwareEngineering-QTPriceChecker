...
namespace QTPriceChecker.Logic.Facades.Account
{
    ...
    public sealed partial class UsersFacade : FacadeObject, Contracts.Account.IUsersAccess<TModel>
    {
        ...
        public UsersFacade()
        : base(new QTPriceChecker.Logic.Controllers.Account.UsersController())
        {
            Constructing();
            Constructed();
        }
        public UsersFacade(FacadeObject facadeObject)
        : base(new QTPriceChecker.Logic.Controllers.Account.UsersController(facadeObject.ControllerObject))
        {
            Constructing();
            Constructed();
        }
