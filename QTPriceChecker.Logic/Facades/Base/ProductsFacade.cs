...
{
    using TModel = Models.Base.Product;
    using TEntity = Entities.Base.Product;
    using System;
    public sealed partial class ProductsFacade : FacadeObject, Contracts.Base.IProductsAccess<TModel>
    {
        private Contracts.Base.IProductsAccess<TEntity> Controller => (ControllerObject as Contracts.Base.IProductsAccess<TEntity>)!;
#if ACCOUNT_ON
        ...
        : base(new QTPriceChecker.Logic.Controllers.Base.ProductsController())
        {
            Constructing();
            Constructed();
        }
        public ProductsFacade(FacadeObject facadeObject)
        : base(new QTPriceChecker.Logic.Controllers.Base.ProductsController(facadeObject.ControllerObject))
        {
            Constructing();
            Constructed();
        }
