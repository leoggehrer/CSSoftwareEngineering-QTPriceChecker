...
{
    using TModel = Models.Base.Supplier;
    using TEntity = Entities.Base.Supplier;
    using System;
    public sealed partial class SuppliersFacade : FacadeObject, Contracts.Base.ISuppliersAccess<TModel>
    {
        private Contracts.Base.ISuppliersAccess<TEntity> Controller => (ControllerObject as Contracts.Base.ISuppliersAccess<TEntity>)!;
#if ACCOUNT_ON
        ...
        : base(new QTPriceChecker.Logic.Controllers.Base.SuppliersController())
        {
            Constructing();
            Constructed();
        }
        public SuppliersFacade(FacadeObject facadeObject)
        : base(new QTPriceChecker.Logic.Controllers.Base.SuppliersController(facadeObject.ControllerObject))
        {
            Constructing();
            Constructed();
        }
