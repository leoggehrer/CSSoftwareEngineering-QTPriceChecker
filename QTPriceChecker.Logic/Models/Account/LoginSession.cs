...
namespace QTPriceChecker.Logic.Models.Account
{
    public partial class LoginSession : VersionModel
    {
        ...
        static partial void BeforeCreate(QTPriceChecker.Logic.Entities.Account.LoginSession other);
        static partial void AfterCreate(QTPriceChecker.Logic.Models.Account.LoginSession instance, QTPriceChecker.Logic.Entities.Account.LoginSession other);
    }
}
#endif
//MdEnd
