...
using QTPriceChecker.Logic.Controllers;
using QTPriceChecker.Logic.Entities.Account;
using QTPriceChecker.Logic.Modules.Exceptions;
using QTPriceChecker.Logic.Modules.Security;
...
namespace QTPriceChecker.Logic.Modules.Account
{
                ...
                if (session != null && session.IsActive)
                {
                    ...
                    if (identity != null)
                    {
                        ...
                        session.JsonWebToken = JsonWebToken.GenerateToken(new Claim[]
                        {
                            ...
                            new Claim(ClaimTypes.System, nameof(QTPriceChecker)),
